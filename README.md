...
1.How to utilize the search bar, not sure which function to use.
2.How do priorities work.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/bGqsoWF.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
1.Not knowing how to use the search bar.
